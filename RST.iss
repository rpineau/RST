...
#define MyAppName "Rainbow Astro RST mount X2 PlugIn"
...
AppId={{24895C4F-DD30-489F-BE34-7894E0D35B41}
AppName={#MyAppName}
...
OutputBaseFilename=RST_X2_Installer
...
[Files]
Source: "mountlist RST.txt";                DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "mountlist RST.txt";                DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "mountlist64 RST.txt"
; 32 bits
Source: "libRST\Win32\Release\libRST.dll";  DestDir: "{app}\Plugins\MountPlugIns"; Flags: ignoreversion
Source: "RST.ui";                           DestDir: "{app}\Plugins\MountPlugIns"; Flags: ignoreversion
Source: "RainbowAstro.png";                 DestDir: "{app}\Plugins\MountPlugIns"; Flags: ignoreversion
; 64 bits
Source: "libRST\x64\Release\libRST.dll";    DestDir: "{app}\Plugins64\MountPlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\MountPlugIns'))
Source: "RST.ui";                           DestDir: "{app}\Plugins64\MountPlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\MountPlugIns'))
